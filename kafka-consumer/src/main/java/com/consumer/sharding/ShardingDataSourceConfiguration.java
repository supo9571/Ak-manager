...
public class ShardingDataSourceConfiguration {
    ...
    TableRuleConfiguration getOrderTableRuleConfiguration() {
        ...
        orderTableRuleConfig.setLogicIndex("sys_time");
        ...
        orderTableRuleConfig.setTableShardingStrategyConfig(
                new StandardShardingStrategyConfiguration("sys_time", TableShardingAlgorithm.class.getName()));
    ...
    private Map<String, DataSource> createDataSourceMap() {
        ...
        result.put("sys-data_202108",
                createDataSource("jdbc:mysql://54.151.183.63:3306/sys-data_202108?characterEncoding=utf8&useSSL=false"));
        result.put("sys-data_202109",
                createDataSource("jdbc:mysql://54.151.183.63:3306/sys-data_202109?characterEncoding=utf8&useSSL=false"));
        return result;
    }
