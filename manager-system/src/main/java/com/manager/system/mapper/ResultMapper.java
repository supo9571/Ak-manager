...
public interface ResultMapper {
    ...
    List selectGameResult(@Param("beginTime") String beginTime,@Param("endTime") String endTime,@Param("cardName")String cardName);

    Long getGameCount(@Param("beginTime") String beginTime,@Param("endTime") String endTime,@Param("cardName")String cardName);
